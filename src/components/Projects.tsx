...
const Projects: React.FC = () => {
  const projects = [
    ...
    },
    {
      title: "Rent My Ride",
      description:
        "Rentmyride will provide you best luxury cars to rent in Dubai with the best deals! Choose your luxury car and book it now to enjoy your ride!",
    ...
    },
    {
      ...
      description:
        "A responsive weather dashboard that displays current weather conditions and forecasts with beautiful data visualizations.",
      image:
    ...
    },
    {
      ...
      description:
        "A modern portfolio website showcasing creative work with smooth animations and responsive design.",
      image:
    ...
    },
    {
      ...
      description:
        "A comprehensive social media analytics dashboard with real-time metrics and engagement tracking.",
      image:
    ...
    },
    {
      ...
      description:
        "An elegant restaurant website with online reservation system, menu showcase, and customer reviews.",
      image:
